...
export default function RecipientStats({ requests, selectedRecipient, onRecipientSelect }: RecipientStatsProps) {
  const recipientStats = useMemo(() => {
    ...
    requests.forEach(req => {
      const id = req.recipientId || req.recipientEmail || 'anonymous-recipient'
      const name = req.recipientName || req.recipientEmail || 'Unknown Recipient'
      const email = req.recipientEmail || ''
  ...
  const isRecent = (lastReceived: Date) => {
    ...
    return diff < 300000 // Recent within last 5 minutes
  }
        ...
        {recipientStats.map(recipient => (
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              {recipient.recipientEmail && recipient.recipientEmail !== recipient.recipientName && (
